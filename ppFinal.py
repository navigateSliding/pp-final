                ...
                if product[0] == order_product:
                    ...
                    try:            
                        ...
                        if order_quantity <= int(product[2]):                  
                            orders_data.append([f"{order_id:04d}",product[1],order_quantity, order_customer])     # dd the data to the orders list
            ...
            for product in products_data:        
                if product[1] == order_product:
                    ...
                    try:            
                        ...
                        if order_quantity <= int(product[2]):                  
                            orders_data.append([f"{order_id:04d}",product[1],order_quantity, order_customer])     #add the data to the orders list
                            product[2] = int(product[2])- order_quantity        #reduce the product
...
def view_inventory(products_data): #belom cek
